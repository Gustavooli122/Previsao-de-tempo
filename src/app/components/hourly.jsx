  ...
  "domingo"
     ...
     return(
        <main className="bg-[#2f2f49] h-full rounded-2xl  p-3 ">
            ...
            <section className="space-y-3  h-110 sm:h-120 md:h-140 lg:h-160 overflow-y-scroll">
                {hourlyData.map((e,i)=>{
                  const weather = getWeatherInfo(e.code);
                  return ( <section key={i} className="rounded-md  flex sm:flex-col md:flex-row justify-between items-center bg-[#2f2f49] p-3 sm:p-2 md:p-1 border border-[#3b3b57]">
